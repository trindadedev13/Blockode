package dev.trindadedev.theblocklogicsjava.ui.editor.logic;
...
import dev.trindadedev.theblocklogicsjava.databinding.LayoutLogicEditorTopMenuBinding;
...
public class LogicTopMenu extends LinearLayout {
    ...
    private LayoutLogicEditorTopMenuBinding binding;
    ...
    private void initialize() {
        binding = LayoutLogicEditorTopMenuBinding.inflate(LayoutInflater.from(context), this, true);
        binding.tvDelete.setText(getResources().getString(R.string.common_word_delete));
        binding.tvCopy.setText(getResources().getString(R.string.common_word_duplicate));
        binding.tvFavorite.setText(getResources().getString(R.string.common_word_collection));
        binding.tvDetail.setText(getResources().getString(R.string.common_word_detail));

        colorSurfaceContainerHigh = ThemeUtil.getColor(this, com.google.android.material.R.attr.colorSurfaceContainerHigh);
